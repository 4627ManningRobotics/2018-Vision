			...
			public void run() {
				while (true) {
					if (camera.read(frame)) {
						...
						Mat hsvThresholdInput = frame;
						double[] hsvThresholdHue = {37.23021582733812, 69.419795221843};
						double[] hsvThresholdSaturation = {27.51798561151079, 41.774744027303754};
						double[] hsvThresholdValue = {87.14028776978417, 122.27815699658704};
						...
						for(int i=0; i<filterContoursContours.size(); i++) {
							Rect bb = Imgproc.boundingRect(filterContoursContours.get(i));
							System.out.print ("contour " + i + ": " + bb.width);
